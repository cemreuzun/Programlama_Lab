#derste selection sort ogrenildi
#selection sort siralamasi ile diziyi kucukten buyuge siralama yapildi
#binary Search ile arama yapildi
...
my_arrays_2 = [50,25,34,48,36,12,20]

print(MyBinarySearch(my_arrays_2,42))
